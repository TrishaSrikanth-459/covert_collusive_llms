...
def run_openhands_task(
    ...
    # Keep the benchmark harness pinned to OpenHands 0.49, but use GHCR by
    # default because docker.all-hands.dev is not reliably resolvable on VMs.
    image_url = os.getenv("OPENHANDS_IMAGE_URL", "ghcr.io/all-hands-ai/openhands:0.49")
    runtime_image = os.getenv("OPENHANDS_RUNTIME_IMAGE", "ghcr.io/all-hands-ai/runtime:0.49-nikolaik")
